...
<body bgcolor="#282828">
	...
	<div id="movieList" class="moviesByStar">
		...
		List movieAttributes = null;
		%>
		<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
		<table>
			<tr>
			<%for(int i = 0; i < movies.size(); i++) { 
				movieAttributes = (ArrayList) movies.get(i);%>
					<td><a href="getMovie?selected=<%=movieAttributes.get(0)%>">
							<img src="<%=movieAttributes.get(1)%>"  BORDER="0"/>
						</a>
					</td>
			<%} %>
			</tr>
